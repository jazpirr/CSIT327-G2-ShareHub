...
urlpatterns = [
    ...
    path('api/chat/<str:conversation_id>/delete/', views.delete_conversation, name='delete_conversation'),
    path('api/chat/unread-count/', views.unread_count, name='chat_unread_count'),
]
